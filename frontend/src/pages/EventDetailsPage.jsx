...
const EventDetailsPage = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600 mb-2">Your seats have been successfully booked.</p>
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            <p className="font-semibold text-gray-900">{event?.name}</p>
            <p className="text-sm text-gray-600 mt-1">{reservation?.seatNumbers.join(', ')}</p>
          </div>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <button onClick={() => navigate('/events')} className="text-gray-600 hover:text-gray-900 mb-4 flex items-center">
      ...
      {error && (
        <div className="mb-6 p-4 rounded-lg bg-red-50 border border-red-200 text-red-700 text-center">
          {error}
        </div>
      )}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            ...
            {selectedSeats.length > 0 ? (
              <p className="text-gray-600 mt-1">{selectedSeats.join(', ')}</p>
            ) : (
              <p className="text-gray-400 mt-1">No seats selected</p>
            )}
          </div>
